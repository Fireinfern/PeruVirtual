...
namespace PresentationLayer
{
    public partial class Main : Form
    {
        ...
        private void Resize()
        {
            ...
            PanelVideo.Width = this.Width / 5 * 3;
            MachuPicchu.Size = new Size(Width / 5, PanelOpciones.Height);
            Caral.Size = new Size(Width / 5, PanelOpciones.Height);
            Sacsayhuaman.Size = new Size(Width / 5, PanelOpciones.Height);
            Nazca.Size = new Size(Width / 5, PanelOpciones.Height);
            Paracas.Size = new Size(Width / 5, PanelOpciones.Height);

            MachuPicchu.Location = new Point(Width / 5 * 0, MachuPicchu.Location.Y);
            Caral.Location = new Point(Width / 5 * 1, Caral.Location.Y);
            Sacsayhuaman.Location = new Point(Width / 5 * 2, Sacsayhuaman.Location.Y);
            Nazca.Location = new Point(Width / 5 * 3, Nazca.Location.Y);
